...
function display_order_form($order = '') {
// This displays the book form.
// It is very similar to the category form.
// This form can be used for inserting or editing books.
// To insert, don't pass any parameters.  This will set $edit
...
?>
  <form method="post"
        action="<?php echo $edit ? 'edit_order.php' : 'insert_order.php';?>">
  <table border="0">
  <tr>
    <td>Item:</td>
    <td><input type="text" name="item"
         value="<?php echo $edit ? $order['ITEM'] : ''; ?>" /></td>
  </tr>
  <tr>
    <td>Zone:</td>
    <td><input type="text" name="zone"
         value="<?php echo $edit ? $order['ZONE'] : ''; ?>" /></td>
  </tr>
  <tr>
    <td>Address:</td>
    <td><input type="text" name="address"
         value="<?php echo $edit ? $order['ADDRESS'] : ''; ?>" /></td>
   </tr>
  <tr>
    <td>Phone:</td>
    <td><input type="text" name="phone"
         value="<?php echo $edit ? $order['PHONE'] : ''; ?>" /></td>
   </tr>
...
function insert_order2($item, $zone, $address, $phone) {
// insert a new book into the database
