...
?>
  ...
  <tr>
  <td rowspan="2">
  <a href="index.php"><img src="images/Executive.png" alt="Executive" border="0"
  ...
  <?php
     if(isset($_SESSION['admin_user'])) {
       ...
       echo "&nbsp;";//echo "Total Price = $".number_format($_SESSION['total_price'],2);
     }
  ?>
  </td>
  </tr>
...
function do_html_dropdown($x1,$x2,$x3){
?>
<!--
<form>
...
<select id="dropdown" name="dropdown" onchange="show_value(this.option);>
  <option value="NEW"><?php echo $x1; ?></option>
  <option value="OPEN"><?php echo $x2; ?></option>
  <option value="CLOSE"><?php echo $x3; ?></option>
</select>
...
function display_messages($cat_array) {
  if (!is_array($cat_array)) {
     echo "<p>No categories currently available</p>";
     return;
  }
  echo "<table style=\"width:100%\" border=\"1\">";
    echo"<tr><td>From</td><td>To</td><td>Timestamp</td><td>Message</td><td>Status</td><td>Source</td></tr>";
  foreach ($cat_array as $row)  {
    ...
    echo "<td>"; echo $timestamp; echo "</td>";
    echo "<td>"; echo $message; echo "</td>";
    echo "<td>"; echo $status; echo "</td>";
    echo "<td>"; echo $source; echo "</td>";
    echo "</tr>";
...
function display_items($cat_array) {
  if (!is_array($cat_array)) {
     echo "<p>No categories currently available</p>";
     return;
  }
  echo "<table style=\"width:100%\" border=\"1\">";
    echo"<tr><td>Item name</td><td>Brand</td><td>Quantity</td><td>Price</td><td>Genre</td><td>Type</td><td>Rarity</td></tr>";
  foreach ($cat_array as $row)  {
    $name = $row['NAME'];
    $brand = $row['BRAND'];
...
function display_orders($cat_array) {
  if (!is_array($cat_array)) {
     echo "<p>No orders currently available</p>";
     return;
  }
  echo "<table style=\"width:100%\" border=\"1\">";
    echo"<tr><td>Item name</td><td>Zone</td><td>Address</td><td>Phone</td><td>Status</td><td>Order time</td><td>Delivery time</td></tr>";
  foreach ($cat_array as $row)  {
    $item = $row['ITEM'];
    $zone = $row['ZONE'];
    $address = $row['ADDRESS'];
    ...
    echo "<tr>";
    echo "<td>"; echo $item; echo "</td>";
    echo "<td>"; echo $zone; echo "</td>";
    echo "<td>"; echo $address; echo "</td>";
    echo "<td>"; echo $phone; echo "</td>";
    echo "<td>"; echo $status; echo "</td>";
    echo "<td>"; echo $orderTime; echo "</td>";
    echo "<td>"; echo $deliveryTime; echo "</td>";
    echo "</tr>";
  }
  echo "</table>";
  echo "<hr />";
...
function display_supplies($cat_array) {
  if (!is_array($cat_array)) {
     echo "<p>No categories currently available</p>";
     return;
  }
  echo "<table style=\"width:100%\" border=\"1\">";
    echo"<tr><td>Genre</td><td>Zone</td><td>Address</td><td>Type</td></tr>";
  foreach ($cat_array as $row)  {
    $genre = $row['GENRE'];
    $zone = $row['ZONE'];
    $address = $row['ADDRESS'];
